...
function genericPrintNoParens(path, options, print) {
    ...
    case "ImportSpecifier":
        var parts = [path.call(print, n.imported ? "imported" : "id")];
        if (n.local || n.name)
            parts.push(" as ", path.call(print, n.local ? "local" : "name"));
        return concat(parts);

    case "ExportSpecifier":
        var parts = [path.call(print, n.local ? "local" : "id")];
        if(n.exported || n.name) {
            parts.push(" as ", path.call(print, n.exported ? "exported" : "name"));
        }
        return concat(parts);
    ...
    case "ImportNamespaceSpecifier":
        return concat(["* as ", path.call(print, n.local ? "local" : "id")]);

    case "ImportDefaultSpecifier":
        return path.call(print, n.local ? "local" : "id");

    case "ExportAllDeclaration":
        return concat(["export * from ", path.call(print, "source"), ";"]);
    ...
    case "ExportDefaultDeclaration":
        ...
        if (n["default"] || n.type === "ExportDefaultDeclaration") {
            parts.push(" default");
